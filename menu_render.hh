...
namespace KGUI
{
	namespace Colors
	{
		...
		FLinearColor Button_Idle{ 5 / 255.f, 5 / 255.f, 5 / 255.f, 1.0f };
		FLinearColor Button_Hovered{ 7 / 255.f, 7 / 255.f, 7 / 255.f, 1.0f };
		FLinearColor Button_Active{ 8 / 255.f, 8 / 255.f, 8 / 255.f, 1.0f };
		FLinearColor Checkbox_Idle{ 0.17f, 0.16f, 0.23f, 1.0f };
		FLinearColor Checkbox_Hovered{ 5 / 255.f, 5 / 255.f, 5 / 255.f, 1.0f };
		FLinearColor Checkbox_Enabled{ 0.20f, 0.25f, 0.94f, 1.0f };
		FLinearColor Combobox_Idle{ 0.17f, 0.16f, 0.23f, 1.0f };
		FLinearColor Combobox_Hovered{ 7 / 255.f, 7 / 255.f, 7 / 255.f, 1.0f };
		FLinearColor Combobox_Elements{ 5 / 255.f, 5 / 255.f, 5 / 255.f, 1.0f };
